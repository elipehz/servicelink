          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">Encontre e Contrate</span>
                <span className="block text-indigo-600">Serviços Profissionais</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Conecte-se com prestadores de serviços confiáveis em sua região. De manutenção residencial a consultoria profissional, 
                temos especialistas verificados prontos para ajudar.
              </p>
              ...
              <div className="mt-6 flex items-center justify-center lg:justify-start text-sm text-gray-500">
                <div className="flex items-center">
                  ...
                  <span className="ml-2">Profissionais Verificados</span>
                </div>
